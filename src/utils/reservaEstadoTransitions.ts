...
export const RESERVA_ESTADO_VALIDADO: ReservaEstado = 'Validado';
...
export const RESERVA_ESTADO_BACKOFFICE_INICIAL = RESERVA_ESTADO_VALIDADO;
...
export const RESERVA_ESTADO_COLORS: Record<ReservaEstado, string> = {
  ...
  [RESERVA_ESTADO_VALIDADO]: '#8B5CF6',
...
export const RESERVA_ESTADO_TRANSITION_ERROR_MESSAGE =
  'Transición no permitida. Pendiente validación puede pasar a Validado, Confirmado, Pagado o Cancelado; Validado puede pasar a Confirmado, Pagado o Cancelado; Confirmado solo puede pasar a Pagado o Cancelado; Pagado y Cancelado son estados finales.';
