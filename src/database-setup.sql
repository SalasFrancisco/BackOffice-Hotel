...
insert into public.salones (nombre, capacidad, precio_base, descripcion) values
  ('Gran Sal贸n', 200, 15000.00, 'Sal贸n principal con equipamiento completo para eventos grandes'),
  ('Sal贸n Norte', 80, 8000.00, 'Sal贸n mediano ideal para reuniones corporativas'),
  ('Sal贸n Terraza', 50, 6000.00, 'Espacio al aire libre con vista panor谩mica')
...
--   ('Cliente Demo', 'demo2@ejemplo.com', '+54 11 2222 2222', 2, '2025-10-22 14:00:00+00', '2025-10-22 18:00:00+00', 'Pendiente', 8000.00, 'Reuni髇 de directorio', 'UUID-OF-USER'),
