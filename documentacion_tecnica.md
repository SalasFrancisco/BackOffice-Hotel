...
- **Flujo de reservas:** `ReservaForm.tsx`, `ReservaModal.tsx` y `Reservas.tsx` colaboran para un flujo CRUD completo de reservas integrado con clientes, servicios y prevencion de solapes.
